...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DomainCheckSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/crazyLuobo/DomainCheckSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'crazyLuobo' => 'yanwenbo_78201@163.com' }
  s.source           = { :git => 'https://github.com/crazyLuobo/DomainCheckSwift.git', :tag => s.version.to_s }
